			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<a href="<?php echo site_url('admin/master_user/') ?>"><i class="fas fa-arrow-left"></i> Back</a>
					</div>
					<div class="card-body">

						<form action="<?php echo site_url('admin/master_user/add') ?>" method="post" enctype="multipart/form-data" >
							...
							<div class="form-group">
								...
								<select id="plant" name="plant" class="form-control <?php echo form_error('plant_id') ? 'is-invalid':'' ?>">
                    			</select>
								<div class="invalid-feedback">
									<?php echo form_error('plant_id') ?>
								</div>
							</div>
